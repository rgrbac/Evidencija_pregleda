                ...
                <?php
                    ...
                    echo '<table class="table">
                        ...
                        while($record = mysqli_fetch_array($myData)){
                            ...
                            echo "<td><a href=azuriraj_zaposlenika.php?id=".$record['ID']." <button type='button' class='btn btn-info btn-sm btn-block'>Ažuriraj</button></a></td>";
